...
<head>
    ...
    <title>SportsHub - Products</title>
...
<!-- Theme -->
<div class="bg-light text-dark text-center mt-2">
        <h1>Sports Hub</h1><br>
        <h1>Our Products</h1>
</div>
<!-- products -->
<div class="row px-1">
            <!-- fetching products -->
  <?php
    getAllProducts();  # function to fetch all products from the db and display. The common functions are defined in the /functions/common_functions.php
