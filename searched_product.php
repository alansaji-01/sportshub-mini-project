...
<head>
    ...
    <title>SportsHub - Searched</title>
...
<div class="row px-1">
            <!-- fetching products -->
  <?php
    displaySearchedProducts();  # function to fetch searched products from the db and display. The common functions are defined in the /functions/common_functions.php
    getUniqueProductsCat();
    getUniqueProductsTheme();
  ?>
