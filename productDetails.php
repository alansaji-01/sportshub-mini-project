...
<head>
    ...
    <title>SportsHub - product details</title>
    <link rel="stylesheet" href="css/display_all_products.css">
    <style>
      body{
         overflow-x: hidden;
      }
...
<div class="row px-1">
  ...
  <?php
    product__details();  # function to fetch products details from the db and display.
